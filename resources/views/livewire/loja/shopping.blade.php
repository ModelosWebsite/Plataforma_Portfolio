<div style="margin-top: 10rem;">
    ...
    <div class="container mt-5 px-3 px-md-3 px-lg-4 tab-content" data-aos="fade-up" data-aos-delay="300">
        <div class="row gy-5">
            @if (isset($getCollectionsItens) and count($getCollectionsItens) > 0)
                @foreach($getCollectionsItens as $item)
                    <div  style="width: 15rem; height: 25rem;" class="col-lg-4 menu-item text-center align-items-center mt-2 mb-2">
